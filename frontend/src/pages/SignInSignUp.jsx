      ...
      {!googleUser ? (
        ...
        <>
          ...
          <Box display="flex" justifyContent="center" gap={3}>
            <Button variant="contained" onClick={() => handleRoleSelect('Job Seeker')} sx={{ textTransform: 'none' }}>
              I am a Job Seeker
            </Button>
            <Button variant="outlined" onClick={() => handleRoleSelect('Job Provider')} sx={{ textTransform: 'none' }}>
              I am a Job Provider
            </Button>
          </Box>
        </>
