...
import { Container, Typography, TextField, Button, Stack, Snackbar, Alert, MenuItem, Grid, Box, Card, CardContent, Divider, FormControlLabel, Checkbox } from '@mui/material';
...
const mockJobData = {
  ...
  description: 'Help clean and beautify downtown areas.',
  pay: '$10/hr',
...
const EditJob = () => {
  ...
  if (!form) {
    return <Typography textAlign="center" mt={10}>Loading...</Typography>;
  }
